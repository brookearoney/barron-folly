  ...
  if (!data?.request) {
    return (
      <EmptyState
        ...
        action={
          <Link href="/console/dashboard" className="text-orange hover:underline text-sm">
            Back to dashboard
          </Link>
        }
      />
  ...
  return (
    <div>
      ...
      <div className="flex items-center gap-2 text-sm text-muted mb-6">
        <Link href="/console/dashboard" className="hover:text-foreground transition-colors">
          Dashboard
        </Link>
        <span>/</span>
                        ...
                        <>
                          {(entry.details as Record<string, unknown>).from && (
                            <p className="text-muted text-xs">
                              {String((entry.details as Record<string, unknown>).from)} → {String((entry.details as Record<string, unknown>).to)}
                            </p>
                          )}
                        </>
                      )}
