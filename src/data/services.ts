...
export const services: Service[] = [
  {
    ...
    longDesc:
      "We deploy autonomous AI agents that handle the heavy lifting of digital execution. From building web platforms and applications to configuring CRM systems and creating reporting infrastructure, our agentic layer compresses timelines that used to take months into weeks. Every deployment is production-grade, scalable, and built to evolve with your business.",
    ...
    seo: {
      ...
      description:
        "Autonomous AI agents deploy web platforms, applications, automations, and reporting infrastructure. Barron & Folly compresses months of execution into weeks.",
      keywords: [
        "agentic execution",
